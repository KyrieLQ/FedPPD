...
"Cora", "CiteSeer", "PubMed", "Physics", "Computers", "Photo", "Chameleon", "Squirrel", "ogbn-arxiv", "ogbn-products", "Tolokers", "Actor", \
...
supported_fl_algorithm = [ "isolate", "fedavg", "fedprox", "scaffold", "moon", "feddc", "fedproto", "fedtgp", "fedpub", "fedstar", "fedgta", "fedtad", "gcfl_plus", "fedsage_plus", "adafgl", "feddep","fedppd"]
...
parser.add_argument('--it_g', type=int, default=10)
parser.add_argument('--lr_g', type=float, default=3)
parser.add_argument('--it_t', type=int, default=10)
...
# evaluation settings
parser.add_argument("--metrics", type=str, default=["accuracy"], action='append')
