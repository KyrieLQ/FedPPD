...
class FedStarClient(BaseClient):
    ...
    def get_custom_model(self):
        return DecoupledGIN(input_dim=self.task.num_feats, hid_dim=self.args.hid_dim, output_dim=self.task.num_classes,
                            n_se=self.n_se, num_layers=self.args.num_layers, dropout=self.args.dropout).to(self.device)
